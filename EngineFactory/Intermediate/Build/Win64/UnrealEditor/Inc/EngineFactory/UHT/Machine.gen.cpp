...
void AMachine::StateChange(bool Acting)
{
	Machine_eventStateChange_Parms Parms;
	Parms.Acting=Acting ? true : false;
...
#endif // WITH_METADATA
	static void NewProp_Acting_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_Acting;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
void Z_Construct_UFunction_AMachine_StateChange_Statics::NewProp_Acting_SetBit(void* Obj)
{
	((Machine_eventStateChange_Parms*)Obj)->Acting = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_AMachine_StateChange_Statics::NewProp_Acting = { "Acting", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(Machine_eventStateChange_Parms), &Z_Construct_UFunction_AMachine_StateChange_Statics::NewProp_Acting_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMachine_StateChange_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMachine_StateChange_Statics::NewProp_Acting,
};
...
struct Z_Construct_UClass_AMachine_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AMachine_StateChange, "StateChange" }, // 4135782811
...
struct Z_CompiledInDeferFile_FID_JIHO_UE5_DT_EngineFactory_EngineFactory_Source_EngineFactory_Machine_h__Script_EngineFactory_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMachine, AMachine::StaticClass, TEXT("AMachine"), &Z_Registration_Info_UClass_AMachine, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMachine), 1750922090U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_JIHO_UE5_DT_EngineFactory_EngineFactory_Source_EngineFactory_Machine_h__Script_EngineFactory_2730045786(TEXT("/Script/EngineFactory"),
